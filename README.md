...
There are many tools that can be used to review your merge request. See [this pr](https://github.com/JoshuaVarga/ai-mr-review/pull/1) for an example.

Try one of the following yourself:
...
- [Copilot](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/request-a-code-review/use-code-review?tool=webui)
- [Claude](https://code.claude.com/docs/en/code-review)
- [GitLab Duo](https://docs.gitlab.com/user/project/merge_requests/duo_in_merge_requests/#use-gitlab-duo-to-review-your-code)
